package admin.emart.com.common.web;
...
public class CommonController {
	...
	public ModelAndView main(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		List<CommonVO> list = commonService.main();

		for(int i=0; i<list.size(); i++) {
			System.out.println(">>>>> " + list.get(i).getCust_id());
		}
     ...
     * @throws Exception
	 */
	@RequestMapping(value="a/traders/main/main.do")
...
//     * @throws Exception
//	 */
//	@RequestMapping(value="/common/redisStart.do")
...
//     * @throws Exception
//	 */
//	@RequestMapping(value="/common/pdfReader.do")
